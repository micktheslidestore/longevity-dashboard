    ...
    <div style={{
      ...
      <div style={{ padding: "14px 20px", borderTop: `1px solid ${T.border}`, marginTop: "auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
          <span style={{
            width: 6, height: 6, borderRadius: "50%", background: T.ok, flexShrink: 0,
        ...
        <div style={{
          ...
          fontFamily: T.sans, fontSize: 11, color: T.ink4, marginBottom: 2,
        }}>
          <span>AL score</span>
        ...
        <div style={{ paddingTop: 10, borderTop: `1px solid ${T.border}`, marginTop: 8 }}>
          <button
            onClick={() => router.push("/")}
            style={{ fontFamily: T.sans, fontSize: 11, color: T.ink4, cursor: "pointer" }}
          >
            ← Switch product
          </button>
        </div>
